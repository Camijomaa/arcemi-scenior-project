            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        ...
                        $settings=DB::table('settings')->get();
                        @endphp
                        <a href="{{route('home')}}"><img style="width:50%" src="@foreach($settings as $data) {{$data->logo}} @endforeach" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                ...
                <div class="container mt-5">
                    <h4 class="mb-3">Search Products by Image</h4>

                    <div class="d-flex flex-wrap align-items-center gap-2">
                        <input type="file" id="homeImageUpload" accept="image/*" class="form-control" style="max-width: 300px;">
                        <button class="btn btn-primary" onclick="searchByImage('homeImageUpload', 'homeResults')">
                            Search
                        </button>
                    </div>

                    <div id="homeResults" class="d-flex flex-wrap gap-3 mt-4"></div>
                </div>
